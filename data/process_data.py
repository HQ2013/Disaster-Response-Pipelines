...
Arguments:
    1) Input  File 1: disaster_messages.csv         - CSV file containing messages
    2) Input  File 2: disaster_categories.csv       - CSV file containing categories
    3) Output File:   DisasterResponse_Processed.db - SQLite database
"""
...
def load_data(messages_filepath, categories_filepath):
    ...
    Output:
        df -> Return merged data as Pandas DataFrame
    """
